...
use Rangkotodotcom\Pushnotif\Validators\NotificationTransactionFormValidation;

class PostNotificationTransaction implements PostNotification
{
    ...
    {
        $validated = NotificationTransactionFormValidation::validate($data);
