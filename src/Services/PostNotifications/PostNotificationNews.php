...
use Rangkotodotcom\Pushnotif\Validators\NotificationNewsFormValidation;

class PostNotificationNews implements PostNotification
{
    ...
    {
        $validated = NotificationNewsFormValidation::validate($data);
