 ...
 * @method static \Rangkotodotcom\Pushnotif getNews(string $id = null, bool $withClient = true, int $limit = 10, int $offset = 0)
 ...
 * @method static \Rangkotodotcom\Pushnotif getInformation(string $id = null, bool $withClient = true, int $limit = 10, int $offset = 0)
